...
#获取文件名
file_name=['./dqn_DLEDMD_test_result/','./dqn_KEDMD_test_result/','dqn_SWMM_test_result/',
           './ppo_DLEDMD_test_result/','./ppo_KEDMD_test_result/','ppo_SWMM_test_result/']
...
colors=['r','g','b','c','m','k']
labels=[['DLEDMD-DQN'],['KEDMD-DQN'],['SWMM-DQN'],['DLEDMD-PPO'],['KEDMD-PPO'],['SWMM-PPO']]
it=0
...
for name in file_name:
    ...
    #all_rate.sort()
    #print(name+':')
    #print('5%:',all_rate[int(N*5/100)],' ',
    #      '50%:',all_rate[int(N*50/100)],' ',
    #      '95%:',all_rate[int(N*95/100)])
