...
if __name__=='__main__':
    ...
    envK=env_Linear.env_Linear(rainData)
    K_DQN = DDQN.DDQN(step=step,batch_size=batch_size,num_rain=rain_num,env=envK,t='dqn_Linear')
    t1=time.time()
    K_DQN.train()
    t2=time.time()
    print(t2-t1)
    ...
    K_DQN = DDQN.DDQN(step=step,batch_size=batch_size,num_rain=rain_num,env=envS,t='dqn_Linear')
